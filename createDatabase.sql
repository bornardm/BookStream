...
VALUES
('1984', 'George Orwell', '1949-06-08', 'Secker & Warburg', 328, '9780451524935', 'A dystopian social science fiction novel.', 1, 0, 0, 8, '2024-03-01', '2024-03-18', 'path/to/image3.jpg', 'Heartstopper', 1, 'A thought-provoking novel.', 'Fiction, Dystopian', 'English'),
(NULL, 'F. Scott Fitzgerald', 'Harper Lee', 'Charles Scribners Sons', 218, '9780743273565', 'A novel about the American dream.', 1, 0, 0, 9, '2024-01-01', '2024-01-15', 'path/to/image1.jpg', NULL, 1, 'A classic novel.', 'Fiction, Classic', 'English'),
('To Kill a Mockingbird', NULL, '1960-07-11', 'J.B. Lippincott & Co.', 281, '9780061120084', 'A novel about racial injustice in the Deep South.', 2, 0, 0, 10, '2024-02-01', '2024-02-20', 'path/to/image2.jpg', NULL, 1, 'An impactful novel.', 'Fiction, Classic', 'English'),
...
('The Hobbit', 'J.R.R. Tolkien', '1937-09-21', 'George Allen & Unwin', 310, '9780547928227', NULL, 1, 0, 0, 10, '2024-09-01', '2024-09-20', 'path/to/image8.jpg', 'The Lord of the Rings', 1, 'A wonderful novel.', 'Fiction, Fantasy', 'English'),
('Crime and Punishment', 'Fyodor Dostoevsky', '1866-01-01', 'The Russian Messenger', 671, '9780486415871', 'A novel about the mental anguish of a young man planning a crime.', NULL, 0, 0, 9, '2024-10-01', '2024-10-25', 'path/to/image9.jpg', NULL, 1, 'A psychological novel.', 'Fiction, Psychological', 'Russian'),
...
('The Divine Comedy', 'Dante Alighieri', '1320-01-01', 'Various', 798, '9780142437223', 'A journey through Hell, Purgatory, and Paradise.', 1, 0, 0, 10, '2024-06-01', '2024-07-01', 'path/to/image15.jpg', NULL, NULL, 'A spiritual epic.', 'Fiction, Poetry', 'Italian'),
